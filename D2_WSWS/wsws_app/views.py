...
class FileView(TemplateView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        path ='E:\\user_jeff\Jupyter_Notebooks\Project Gillette\D2_WSWS\static\wsws_file\wsws_sheet.xlsx'
        ...
        wb.save('E:\\user_jeff\Jupyter_Notebooks\Project Gillette\D2_WSWS\static\wsws_file\d2_wsws.xlsx')
        file_4 = static('wsws_file\d2_wsws.xlsx')
